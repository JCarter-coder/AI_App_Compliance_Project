...
try:
  ...
  sidebar_input = st.sidebar.selectbox("Select Role", ["Unit Training Manager", "Work Center Supervisor", "Supervisor"])
  ...
  # with sidebar_input: 
  #   if (sidebar_input == "Unit Training Manager"):
  #     st.write("Role: Unit Training Manager")
  #   if (sidebar_input == "Work Center Supervisor"):
  #     st.write("Role: Work Center Supervisor")
